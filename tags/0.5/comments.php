...
<?php if ($comments) : global $sandbox_comment_alt; ?>
...
<?php if ( $comment_count ) : $sandbox_comment_alt = 0; ?>
...
<?php if (get_comment_type() == "comment") : ?>
		<li id="comment-<?php comment_ID() ?>" class="<?php sandbox_comment_class() ?>">
			...
			<div class="comment-metadata">
				<?php printf(__('Posted %1$s at %2$s | <a href="%3$s" title="Permalink to this comment">Permalink</a>', 'sandbox'),
						get_comment_date(),
						get_comment_time(),
...
<?php if ( $ping_count ) : $sandbox_comment_alt = 0; ?>
...
<?php endif; ?>
			...
			<div class="form-submit"><input id="submit" name="submit" type="submit" value="<?php _e('Post Comment &raquo;', 'sandbox') ?>" tabindex="7" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></div>
