...
<?php the_post() ?>
			...
			<h2 class="page-title"><?php printf(__('Author Archives: %s', 'sandbox'), $authordata->display_name) ?></h2>
			<dl id="<?php echo $authordata->user_nicename; ?>-metadata" class="author-metadata">
				<dt><?php printf(__('About %s', 'sandbox'), 
						"<a class='url fn' href='$authordata->user_url' title='$authordata->display_name'>$authordata->display_name</a>" )?></dt>
				<dd><?php echo $authordata->user_description; ?></dd>
			</dl>
