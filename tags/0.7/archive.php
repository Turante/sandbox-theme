...
<?php if ( is_day() ) : ?>
			<h2 class="page-title"><?php printf(__('Daily Archives: <span class="page-meta">%s</span>', 'sandbox'), get_the_time('F jS, Y')) ?></h2>
<?php elseif ( is_month() ) : ?>
			<h2 class="page-title"><?php printf(__('Monthly Archives: <span class="page-meta">%s</span>', 'sandbox'), get_the_time('F Y')) ?></h2>
<?php elseif ( is_year() ) : ?>
			<h2 class="page-title"><?php printf(__('Yearly Archives: <span class="page-meta">%s</span>', 'sandbox'), get_the_time('Y')) ?></h2>
<?php elseif ( is_author() ) : ?>
			<h2 class="page-title"><?php $curauth = sandbox_get_author(); printf(__('Author Archives: <span class="page-meta">%s</span>', 'sandbox'),  $curauth->display_name) ?></h2>
