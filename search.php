...
<?php else : ?>
			...
			<div id="post-0" class="post noresults">
				...
				<form id="noresults-searchform" class="blog-search" method="get" action="<?php bloginfo('home') ?>">
					<div>
						<input name="s" class="text" type="text" value="<?php the_search_query() ?>" size="40" />
